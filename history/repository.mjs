  ...
  return Object.freeze({
    ...
    async health() {
           ...
           EXISTS (
             SELECT 1 FROM arena_schema_migrations
              WHERE version = 7
                ...
                AND schema_checksum = $14
           ) AS keeper_prehash_abandonment_migration_valid,
           EXISTS (
             SELECT 1 FROM arena_schema_migrations
              WHERE version = 8
           ...
           EXISTS (
             SELECT 1 FROM arena_schema_migrations
              WHERE version = 10
                ...
                AND schema_checksum = $17
           ) AS keeper_durable_signed_envelope_migration_valid,
           NOT EXISTS (
      ...
      const schemaReady = state.deployments_exists === true
        ...
        && state.keeper_durable_signed_envelope_migration_valid === true
      ...
      let integrity = Object.freeze({
        ...
        journalSchemaVersion:
          state.keeper_durable_signed_envelope_migration_valid === true ? 10 : null,
      ...
      return Object.freeze({
        ...
        schemaVersion: schemaReady ? 10 : null,
        integrity,
      });
    },
