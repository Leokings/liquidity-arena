...
test('history health requires schema v7, one active Bradbury V8, and complete epoch and payout projections', async () => {
  ...
  assert.match(calls[0].text, /version = 4[\s\S]*version = 5[\s\S]*version = 6[\s\S]*version = 7/);
