...
CONTRACT_PATH = Path("contracts/LiquidityArenaV7.py")
...
def deploy_arena(direct_vm, direct_deploy, direct_owner, treasury, keeper=None):
...
def test_v7_pins_runner_and_exposes_fixed_policy(
    direct_vm,
    direct_deploy,
    direct_owner,
    direct_charlie,
    ...
    assert config["protocol_version"] == "LIQUIDITY_ARENA_V7"
