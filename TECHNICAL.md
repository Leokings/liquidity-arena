...
Public history exposes only V8 deployments, epochs, proofs, and payouts. Health requires exact contract/role/factory/schema identity, schema version 7 with no unknown later migration, complete epoch/payout projections, and verified payout-stage evidence.
